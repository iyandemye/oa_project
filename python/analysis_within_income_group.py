...
# play with this to change the number of affiliated regions
df_same_level = df[df["number_of_income_groups"] < 2]
print("Papers authored by authors in countries within the same income group", len(df_same_level))
df = df_same_level
...
COUNTRY.to_csv("oa_by_country_within_income_group.csv")
...
py.plot(fig, filename='GDP-OA-NEW-within_1_or_2_groups')
...
REGION.to_csv("oa_by_region_within_income_group.csv")
...
LEVEL.to_csv("oa_by_income_group_within_income_group.csv")
print("DONE!")
