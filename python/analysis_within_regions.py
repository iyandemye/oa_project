...
df_same_region = df[df["number_of_regions"] < 2]
...
COUNTRY.to_csv("oa_by_country_within_region_test.csv")
...
py.plot(fig, filename='GDP-OA-NEW_within_region')
...
REGION.to_csv("oa_by_region_within_region_test.csv")
...
LEVEL.to_csv("oa_by_income_group_within_region_test.csv")
print("DONE!")
